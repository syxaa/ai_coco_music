...
import dao.MvNewlistDao;
import dao.MvRanklistDao;
import dao.MvlistDao;
import dao.SonglistDao;
import entity.Mvlist;
import entity.Mvnewlist;
...
public class MvlistServelet extends HttpServlet {
    ...
    private MvRanklistDao mvRanklistDao = new MvRanklistDao();
    private MvNewlistDao mvNewlistDao = new MvNewlistDao();
...
//        }
        ...
        if("GetMvRankListData".equals(method)){
            getMvRankListData(request,response);
            return;
        }
        if("GetMvNewListData".equals(method)){
            getMvNewListData(request,response);
            return;
        }
...
//        page.getContent().add(bookCategory);
    ...
    private void getMvRankListData(HttpServletRequest request,
                               HttpServletResponse response) {
        // TODO Auto-generated method stub
        Page<Mvranklist> page = new Page<Mvranklist>(1, 999);
        page = mvRanklistDao.findList(page);
        Map<String, Object> ret = new HashMap<String, Object>();
//        UniversityCategory bookCategory = new UniversityCategory();
//        bookCategory.setId(0);
//        bookCategory.setName("全部");
//        page.getContent().add(bookCategory);
    ...
    private void getMvNewListData(HttpServletRequest request,
                                   HttpServletResponse response) {
        // TODO Auto-generated method stub
        Page<Mvnewlist> page = new Page<Mvnewlist>(1, 999);
        page = mvNewlistDao.findList(page);
        Map<String, Object> ret = new HashMap<String, Object>();
//        UniversityCategory bookCategory = new UniversityCategory();
//        bookCategory.setId(0);
//        bookCategory.setName("全部");
