 ...
 *
 */
public class SonglistServelet extends HttpServlet {
...
//        }
        ...
        if("GetSongListData".equals(method)){
            getSongListData(request,response);
            return;
        }
    ...
    private void getSongListData(HttpServletRequest request,
